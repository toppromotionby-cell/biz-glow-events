  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {CATALOGS.map((cat) => (
          <Link key={cat.id} to={cat.to} className="group relative glass rounded-xl p-6 hover:border-primary/50 transition-all duration-200 block">
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0">
                <h2 className="font-semibold text-lg leading-tight group-hover:text-primary transition">{cat.title}</h2>
