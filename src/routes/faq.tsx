...
const FAQ: { q: string; a: string }[] = [
  {
    ...
    a: "Выберите интересующие позиции в каталоге и добавьте их в заявку. После отправки наш менеджер свяжется с вами в течение рабочего дня для уточнения деталей и подтверждения дат.",
  },
  {
