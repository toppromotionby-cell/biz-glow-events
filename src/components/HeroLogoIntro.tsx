...
/**
 * Анимированная заставка-логотип для hero-блока.
 * Переливающийся wordmark «event-hub.by» с halo, sheen-блик
 * и парящими искрами. Чистый CSS — без видеофайла, рендерится мгновенно.
 */
