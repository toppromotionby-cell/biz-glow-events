// Конструктор документа КП: выбор шаблона + настраиваемые блоки с плейсхолдерами.
...
import {
  EDITABLE_BLOCK_TYPES, QUOTE_BLOCK_LABELS, QUOTE_BLOCK_TYPES, QUOTE_PLACEHOLDERS,
  QUOTE_TEMPLATES, QUOTE_TEMPLATE_HINTS, QUOTE_TEMPLATE_LABELS,
  defaultBlocksForTemplate, newBlock,
  type QuoteBlock, type QuoteBlockType, type QuoteTemplate,
              ...
              {editable && b.enabled && (
                <div className="space-y-1">
                  ...
                  <Textarea
                    ...
                    placeholder="Можно использовать плейсхолдеры: {{client_company}}, {{event_date}}, {{venue}}, {{total}}…"
                  />
                </div>
              )}
            </div>
